...
// getServerSideProps() -> that function makes a virtual a server that server calculate the page and render to browser. That server is also knows serverSideRendering.
